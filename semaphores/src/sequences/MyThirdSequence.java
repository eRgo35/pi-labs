...
//    private static final Semaphore SEM_A = new Semaphore(0, true);
    ...
    private static final class control extends Thread { //thread definition
        ...
        public void run() {
            try {
                ...
                System.out.println("Thread control: Ooops..." + ex);
            }
            System.out.println("Thread control: I'm done...");
        }
    }
